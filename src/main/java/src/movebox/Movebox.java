...
public class Movebox {
	...
	public static void resuelveTablero() throws IOException {
		//ITablero[] t = Tableros.parseaTableros("android-tablero9.txt");
		ITablero[] t = Tableros.parseaTableros("tablero-dificil.txt");		
		resuelveTablero(t[0], System.out);
	}
		
	public static void resuelveTableros() throws IOException {
		Thread.currentThread().setPriority(Thread.MIN_PRIORITY);
		
		ITablero[] tableros = Tableros.tableros();
		System.out.println( "Resolviendo " + tableros.length + " tableros");
